            ...
            <div className='py-[30px] px-[32px] bg-white mb-[23px] rounded-[4px]'>
              <div className='mb-[30px] text-center'>
                ...
                <p className='font-poppin font-medium text-[13px] text-[#878A99]'>
                  Sign in to continue to ThanhDat.
                </p>
              </div>
              <form action='#'>
                ...
                <Link to="/device-page" className='inline-flex items-center justify-center mb-[23px] rounded-[4px] h-[38px] text-white font-poppin font-normal text-[13px] inline-block w-full bg-[#0AB39C]'>
                  Sign In
                </Link>
              </form>
