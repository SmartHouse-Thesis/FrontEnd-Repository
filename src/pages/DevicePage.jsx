...
export function DevicePage() {
    const productArray = [
        ...
        },
        {
            ...
            amount: '510',
            status: 'Paid',
            published: '06 Jan, 20  21, 01:31 PM'
        },
        {
            productName: 'Branded T-Shirt',
            price: "$29.00",
          ...
          <table>
            ...
            {productArray.map((item) =>
                           ...
                           {/* <td className='px-[21px]'>
                             <div className='flex flex-col items-start'>
                               <span className='font-poppin text-[14px] font-medium'>
                               <Icon icon="material-symbols:edit-outline" className='w-[20px] h-[20px]' style={{color: "#405189"}} />
                               </span>
                           ...
                           <td className='px-[20px]'>
                             <div className='flex flex-col items-start'>
                               <span className='font-poppin text-[14px] font-medium'>
                               <Icon icon="material-symbols:delete-outline" className='w-[20px] h-[20px]' style={{color: "#F06548"}} />
                               </span>
                             </div>
                           </td> */}
                         </tr>
